...
const (
	...
	TestInstructionContainerName_Fenix_EmptySerialContainer TypeAndStructs.TestInstructionContainerNameType = "Emtpy serial processed TestInstructionsContainer"
